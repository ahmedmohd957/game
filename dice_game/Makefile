...
pylint:
	@$(call MESSAGE,$@)
	-cd dice_game && $(PYTHON) -m pylint *.py
...
pydoc:
	@$(call MESSAGE,$@)
	install -d doc/pydoc
	$(PYTHON) -m pydoc -w dice_game/*.py
	mv *.html doc/pydoc

pdoc:
	@$(call MESSAGE,$@)
	pdoc --force --html --output-dir doc/pdoc dice_game/*.py

pyreverse:
	@$(call MESSAGE,$@)
	install -d doc/pyreverse
	pyreverse dice_game/*.py
...
radon-cc:
	@$(call MESSAGE,$@)
	radon cc --show-complexity --average dice_game

radon-mi:
	@$(call MESSAGE,$@)
	radon mi --show dice_game
